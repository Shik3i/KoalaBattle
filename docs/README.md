...
- [Themes and layouts](THEMES.md)

The README owns quick-start commands. These pages own detailed contracts; avoid duplicating
environment-variable lists or lifecycle rules in multiple documents.
