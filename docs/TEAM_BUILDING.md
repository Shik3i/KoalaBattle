...
Phase 5 supports custom teams for `gen9ou`. Random Battle remains Showdown-generated and needs
...
carry the format and team policy. Phase 5 accepts fixed Gen 9 OU teams; per-series rotation or
