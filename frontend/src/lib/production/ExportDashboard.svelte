...
<style>
  ...
  .export{display:grid;gap:1rem;margin-top:1rem;padding:1rem}.export-head,.controls{display:flex;align-items:center;justify-content:space-between;gap:.7rem;flex-wrap:wrap}.export-head h2{margin:.2rem 0 0}.export-head>span{padding:.35rem .55rem;border:1px solid var(--border);border-radius:999px;color:var(--muted);font:0.72rem var(--mono)}.export-head>span.ready{border-color:var(--accent);color:var(--accent)}.controls{align-items:end}.controls label{min-width:145px;flex:1}.controls input,.controls select{min-height:42px}.preflight{padding:1rem;border:1px solid var(--border);border-radius:var(--radius);background:var(--panel-strong)}.preflight header{display:flex;align-items:center;justify-content:space-between}.preflight header div{display:grid;gap:.2rem}.preflight>div{display:grid;grid-template-columns:repeat(auto-fit,minmax(125px,1fr));gap:1px;margin-top:.8rem;overflow:hidden;border:1px solid var(--border);border-radius:.6rem;background:var(--border)}.preflight>div span{display:grid;gap:.25rem;padding:.7rem;background:var(--panel)}.preflight small{color:var(--muted);font:0.72rem var(--mono);text-transform:uppercase}.preflight span strong{color:var(--warning);font-size:.72rem;text-transform:capitalize}.preflight span[data-ready='true'] strong{color:var(--accent)}.preflight p{margin:.7rem 0 0;color:var(--warning);font-size:.72rem}.jobs{display:grid;gap:.65rem}.jobs article{display:grid;grid-template-columns:minmax(180px,1.4fr) minmax(180px,.9fr) minmax(160px,1fr) 55px auto;align-items:center;gap:.8rem;padding:.8rem;border:1px solid var(--border);border-radius:.7rem;background:var(--panel-strong)}.jobs article>div:first-child,.job-status{display:grid;gap:.2rem}.jobs article span,.jobs article small{color:var(--muted);font:0.72rem var(--mono)}.job-status b{text-transform:uppercase;font:0.72rem var(--mono)}.job-status b[data-status='completed']{color:var(--accent)}.job-status b[data-status='failed']{color:var(--danger)}progress{width:100%;accent-color:var(--accent)}.actions{display:flex;gap:.4rem;flex-wrap:wrap}.actions a,.actions button{padding:.45rem .55rem;border:1px solid var(--border);border-radius:.4rem;background:transparent;color:var(--text);font:0.72rem var(--mono);text-decoration:none}.jobs article>small,.jobs article>.error,.jobs article>details{grid-column:1/-1}.jobs details{padding:.55rem .65rem;border:1px solid var(--border);border-radius:.45rem}.jobs summary{cursor:pointer;color:var(--muted);font:0.72rem var(--mono)}.jobs details small{display:block;margin-top:.45rem}.empty{display:grid;gap:.3rem;padding:1rem;border:1px dashed var(--border);border-radius:.7rem;color:var(--muted)}.empty strong{color:var(--text)}@media(max-width:900px){.jobs article{grid-template-columns:1fr 1fr}.jobs article progress{grid-column:1/-1}.jobs article output{display:none}.actions{justify-content:end}}@media(max-width:560px){.controls{display:grid;grid-template-columns:1fr}.controls label,.controls button{width:100%}.jobs article{grid-template-columns:1fr}.jobs article progress,.jobs article .actions{grid-column:1}.actions{justify-content:start}}
</style>
