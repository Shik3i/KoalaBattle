...
<style>
  ...
  .winner-format{color:var(--r-dim);font:600 calc(var(--hud-scale,1) * clamp(0.68rem,.78cqw,0.82rem)) var(--mono);letter-spacing:.12em;text-transform:uppercase}
  ...
  .winner-mvp b{color:var(--champion);font:900 calc(var(--hud-scale,1) * clamp(0.68rem,.85cqw,0.9rem)) var(--mono);letter-spacing:.2em}
  .winner-mvp em{color:#fff;font:800 calc(var(--hud-scale,1) * clamp(.86rem,1.1cqw,1.15rem)) var(--display);font-style:normal}
  .winner-mvp i{color:var(--r-dim);font:600 calc(var(--hud-scale,1) * clamp(0.68rem,.85cqw,0.9rem)) var(--mono);font-style:normal}
  ...
  .recap header b{overflow:hidden;color:#fff;font:800 calc(var(--hud-scale,1) * clamp(.7rem,.92cqw,.95rem)) var(--display);text-overflow:ellipsis;white-space:nowrap}
  .recap header span{color:var(--r-dim);font:600 calc(var(--hud-scale,1) * clamp(0.68rem,.74cqw,0.78rem)) var(--mono)}
  ...
  .recap li>b{overflow:hidden;color:#eaf4ee;font:700 calc(var(--hud-scale,1) * clamp(0.68rem,.78cqw,0.82rem)) var(--display);text-overflow:ellipsis;white-space:nowrap}
  ...
  .recap li em{color:var(--r-dim);font:600 calc(var(--hud-scale,1) * clamp(0.68rem,.72cqw,0.76rem)) var(--mono);font-style:normal}
  .recap li u{padding:.04rem .3rem;border-radius:4px;background:color-mix(in srgb,var(--champion) 26%,transparent);color:#fff;font:800 calc(var(--hud-scale,1) * clamp(0.68rem,.68cqw,0.76rem)) var(--mono);text-decoration:none}

  .director-card{position:absolute;z-index:50;inset:0;display:grid;place-content:center;justify-items:center;gap:.65rem;padding:2rem;background:#020408;text-align:center;pointer-events:none}.director-card::before,.director-card::after{content:'';position:absolute;inset:0}.director-card::before{background:linear-gradient(112deg,rgba(95,227,154,.23) 0 38%,transparent 38% 62%,rgba(201,140,255,.2) 62%)}.director-card::after{background:repeating-linear-gradient(112deg,transparent 0 15%,rgba(255,255,255,.06) 15.1% 15.5%,transparent 15.6% 28%);mix-blend-mode:screen}.director-card>*{position:relative;z-index:1}.director-card small{color:#baf8ca;font:900 calc(var(--hud-scale,1) * clamp(0.68rem,1cqw,1.0rem)) var(--mono);letter-spacing:.28em}.director-card strong{max-width:90%;color:#fff;font:900 calc(var(--hud-scale,1) * clamp(2rem,5.5cqw,5.8rem))/1 var(--display);text-transform:uppercase;text-shadow:0 8px 32px rgba(0,0,0,.75)}.director-card strong i{font-style:normal;color:#ffd262;font-size:.48em}.director-card span:not(.director-mark){color:rgba(240,246,242,.86);font:800 calc(var(--hud-scale,1) * clamp(.68rem,1.05cqw,1.05rem)) var(--mono);text-transform:uppercase}.director-mark{display:grid;place-items:center;width:clamp(50px,7cqw,92px);aspect-ratio:1;border:1px solid rgba(255,255,255,.22);border-radius:18px;background:rgba(0,0,0,.25)}.director-mark img{width:62%}
  ...
  .versus{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:clamp(0.68rem,2.4cqw,2.4rem);width:min(94%,58cqw)}
  ...
  .versus-side>i{color:rgba(240,246,242,.72);font:700 calc(var(--hud-scale,1) * clamp(0.68rem,.9cqw,0.95rem)) var(--mono);font-style:normal;text-transform:uppercase}
