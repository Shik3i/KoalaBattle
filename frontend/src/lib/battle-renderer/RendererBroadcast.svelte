...
<style>
  ...
  .team-strip img{width:145%;height:145%;object-fit:contain;image-rendering:pixelated}.team-strip>i>b{color:var(--r-dim);font:800 0.68rem var(--display)}.team-strip>i.unrevealed{border-color:rgba(255,255,255,.16);background:rgba(0,0,0,.24)}.team-strip>i.fainted{border-color:rgba(255,255,255,.12);background:rgba(0,0,0,.4);opacity:.38;filter:grayscale(1) brightness(.65)}.team-strip>i.fainted::after{content:'';position:absolute;width:132%;height:1px;background:rgba(255,255,255,.5);transform:rotate(-45deg)}.team-strip>i.active{border-color:#fff;background:color-mix(in srgb,var(--side-color) 26%,transparent);box-shadow:0 0 0 1px rgba(255,255,255,.5)}
