...
<style>
  ...
  .battle-renderer.deterministic .sprite,.battle-renderer.deterministic .pulse-ring,.battle-renderer.deterministic .effect span,.battle-renderer.deterministic .winner-banner{animation-play-state:paused!important;animation-delay:var(--logical-elapsed)!important}.battle-renderer.deterministic .hp-track i{transition:none!important}
