<script lang="ts">
  ...
  import { api, apiBase, configureProvider, wsBase } from '$lib/api';
  ...
  async function loadData() {
    try {
      ...
      const [nextAssets, nextMatches, nextProviders, nextSpeechProviders, nextVoices, nextVideo] = await Promise.all([
