...
<section class="hero">
  ...
  <p class="lede">Run isolated battles, durable tournaments, or a seeded Draft run where every Gym stage is played and archived through the same Pokémon Showdown engine.</p>
  <div class="actions"><a class="button" href="/challenges/new"><i class="ph ph-map-trifold" aria-hidden="true"></i>Start Draft</a><a class="button secondary" href="/tournaments/new"><i class="ph ph-trophy" aria-hidden="true"></i>Create tournament</a><a class="button secondary" href="/new"><i class="ph ph-sword" aria-hidden="true"></i>Create match</a></div>
</section>
<section class="principles">
  ...
  <article><span><i class="ph ph-flow-arrow" aria-hidden="true"></i>02</span><h2>Scheduling durable</h2><p>Global and tournament concurrency limits keep queued work bounded.</p></article>
  <article><span><i class="ph ph-clock-counter-clockwise" aria-hidden="true"></i>03</span><h2>History independent</h2><p>Recorded events replay without Showdown, providers, or an active runtime.</p></article>
</section>
{#if matches.length}
...
<style>
  .principles article>span{display:flex;align-items:center;gap:.4rem}.principles article>span .ph{font-size:1.05rem}
