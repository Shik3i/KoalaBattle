...
<style>
  .director-head{align-items:center}.head-actions{display:flex;gap:.6rem}.system-strip{display:grid;grid-template-columns:repeat(5,1fr);gap:1px;margin-bottom:1rem;overflow:hidden;border:1px solid var(--border);border-radius:var(--radius-lg);background:var(--border)}.system-strip article{display:grid;padding:1rem;background:var(--panel)}.system-strip strong{font-size:1.45rem;text-transform:capitalize}.system-strip span{color:var(--muted);font:0.72rem var(--mono)}.system-strip .bad strong{color:var(--danger)}.filters{display:grid;grid-template-columns:2fr 1fr auto;align-items:end;gap:.7rem;padding:1rem;box-shadow:none}.director-grid{display:grid;grid-template-columns:minmax(0,2fr) minmax(270px,.8fr);gap:1rem;margin-top:1rem}.director-main,.card-stack,aside{display:grid;align-content:start;gap:1rem}.director-section{padding-block:1rem}.director-section>header,.side-panel>header{display:flex;align-items:end;justify-content:space-between;margin-bottom:.8rem}
  /* A bare text link in a section header is only as tall as its line box — 14px, under
     the 24px minimum target size. */
  .director-section>header>a,.side-panel>header>a{display:inline-flex;align-items:center;min-height:24px;color:var(--accent);font-weight:650}.director-section h2{margin:.25rem 0}.director-section>header>span{color:var(--muted);font:1rem var(--mono)}.director-section>header>a,.side-panel header a{color:var(--accent);font-size:.72rem}.side-panel{padding:1rem;box-shadow:none}.tournament-row{display:flex;align-items:center;justify-content:space-between;gap:.5rem;padding:.8rem 0;border-bottom:1px solid var(--border)}.tournament-row>span:first-child{display:grid}.tournament-row small{color:var(--muted);font:0.72rem var(--mono);text-transform:capitalize}.provider-list{display:grid;margin-top:.8rem}.provider-list>span{display:grid;grid-template-columns:10px 1fr auto;align-items:center;gap:.5rem;padding:.55rem 0;border-bottom:1px solid var(--border)}.provider-list i{width:7px;aspect-ratio:1;border-radius:50%;background:var(--muted)}.provider-list i.ready{background:var(--accent)}.provider-list small{color:var(--muted);font:0.72rem var(--mono)}.warning p,.empty{color:var(--muted);font-size:.78rem;line-height:1.6}@media(max-width:900px){.system-strip{grid-template-columns:repeat(3,1fr)}.director-grid{grid-template-columns:1fr}}@media(max-width:600px){.director-head{align-items:stretch;flex-direction:column}.head-actions{display:grid;grid-template-columns:1fr 1fr}.system-strip{grid-template-columns:1fr 1fr}.filters{grid-template-columns:1fr}.filters button{width:100%}}
</style>
