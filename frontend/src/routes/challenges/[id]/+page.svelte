...
{#if run.status === 'drafting' && run.current_offer}
  <section id="draft" class="draft panel" aria-labelledby="draft-title">
    ...
    <header class="roll-result">
      ...
      <span class="draft-info" data-tooltip={run.definition.draft_rules.draft_pool_mode === 'base-forms-only' ? 'Only first-stage and single-stage Pokémon can appear. Evolved forms were removed from this run’s pool; drafted Pokémon can evolve during the campaign. Points use the strongest reachable non-Mega evolution.' : 'Higher-rated Pokémon appear less often. Points use the strongest reachable non-Mega evolution. Already-evolved forms are much rarer because base forms evolve during the campaign.'}><button type="button" aria-label="How Draft rarity and evolution weighting work"><i class="ph ph-info" aria-hidden="true"></i></button></span>
    </header>
...
<style>.battle-summary{display:grid;grid-template-columns:1fr 1fr;gap:.5rem;margin-top:.6rem}.battle-summary>div{padding:.5rem .55rem;border:1px solid var(--border);border-radius:.65rem;background:var(--panel-strong)}.battle-summary>div>strong,.battle-summary>div>small{display:block;margin-bottom:.4rem}.battle-summary>div>small{margin:.45rem 0 .25rem;color:var(--muted);font:0.72rem var(--mono);text-transform:uppercase}.battle-summary>div>div{display:flex;flex-wrap:wrap;gap:.35rem}.battle-summary span{display:flex;align-items:center;gap:.28rem;padding:.18rem .38rem;border-radius:.45rem;background:var(--surface);font-size:0.72rem}.battle-summary span.fainted{opacity:.68;filter:grayscale(.75)}.battle-summary span.opponent{border:1px solid color-mix(in srgb,var(--danger) 30%,var(--border))}.battle-summary em{color:var(--muted);font:0.72rem var(--mono)}.result-copy{min-width:0;flex:1}.battle-history{margin-bottom:.9rem;padding:1.25rem;box-shadow:none}.battle-history>summary{display:flex;align-items:center;gap:.5rem;font:700 .85rem var(--display);cursor:pointer}.battle-history ol{display:grid;gap:.45rem;margin:.8rem 0 0;padding:0;list-style:none}.battle-history li{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:.7rem;border:1px solid var(--border);border-radius:.6rem;background:var(--panel-strong)}.battle-history li>div{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:.2rem .55rem}.battle-history li small{grid-column:2;color:var(--muted);font:0.72rem var(--mono)}.draft-history{margin-bottom:.9rem;padding:1rem;box-shadow:none}.draft-history>summary{font-weight:700}.draft-history ol{display:grid;gap:.6rem;margin:.9rem 0 0;padding:0;list-style:none}.draft-history li{padding:.75rem;border:1px solid var(--border);border-radius:.6rem;background:var(--panel-strong)}.draft-history li header{display:flex;align-items:center;justify-content:space-between;gap:.6rem}.draft-history li>div{display:flex;flex-wrap:wrap;gap:.4rem;margin-top:.55rem}.draft-history li>div>span{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:0 .4rem;min-width:145px;padding:.35rem .5rem;border:1px solid var(--border);border-radius:.5rem;color:var(--muted)}.draft-history li>div>span.selected{border-color:var(--accent);background:color-mix(in srgb,var(--accent) 8%,transparent);color:var(--text)}.draft-history li>div small{grid-column:2;font:0.72rem var(--mono)}.history-outcome{padding:.25rem .45rem;border-radius:999px;background:color-mix(in srgb,var(--warning) 10%,transparent);color:var(--warning);font:0.72rem var(--mono)}.history-outcome.picked{background:color-mix(in srgb,var(--accent) 10%,transparent);color:var(--accent)}.breadcrumbs{display:flex;align-items:center;gap:.35rem;margin-bottom:.8rem;color:var(--muted);font:0.72rem var(--mono)}.breadcrumbs a{color:var(--accent)}.page-head p,.panel p{color:var(--muted);line-height:1.5}.head-actions{display:flex;align-items:center;gap:.6rem}.button.danger{border-color:color-mix(in srgb,var(--danger) 45%,var(--border));background:transparent;color:var(--danger)}.continue-card{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:.8rem;padding:1.15rem;border-color:color-mix(in srgb,var(--accent) 42%,var(--border));background:linear-gradient(110deg,color-mix(in srgb,var(--accent) 8%,var(--panel)),var(--panel))}.continue-card h2{margin:.2rem 0}.snapshot-warning,.result-card{display:flex;align-items:flex-start;gap:.9rem;margin-bottom:.7rem;padding:.9rem 1rem}.snapshot-warning>i{color:var(--warning);font-size:1.7rem}.snapshot-warning p{margin:.25rem 0}.result-card{border-color:color-mix(in srgb,var(--danger) 42%,var(--border))}.result-card.success{border-color:color-mix(in srgb,var(--accent) 48%,var(--border))}.result-card.technical{border-color:color-mix(in srgb,var(--warning) 48%,var(--border))}.result-icon{display:grid;place-items:center;width:52px;aspect-ratio:1;border-radius:50%;background:color-mix(in srgb,var(--danger) 12%,var(--surface));color:var(--danger);font-size:1.6rem}.result-card.success .result-icon{background:color-mix(in srgb,var(--accent) 12%,var(--surface));color:var(--accent)}.result-card.technical .result-icon{background:color-mix(in srgb,var(--warning) 12%,var(--surface));color:var(--warning)}.result-card>div:nth-child(2){flex:1}.result-card h2{margin:.2rem 0}.result-card p{margin:.2rem 0}.result-meta{color:var(--muted);font:0.72rem var(--mono)}.result-actions{display:flex;flex-shrink:0;flex-direction:column;gap:.45rem}.campaign,.draft,.roster,.training,.team-review,.stage,.active,.complete,.ending{margin-bottom:.9rem;padding:1.25rem;box-shadow:none}.campaign header,.draft header,.training header{display:flex;align-items:flex-end;justify-content:space-between;gap:1rem}.campaign h2,.draft h2,.training h2,.team-review h2,.complete h2,.ending h2{margin:.25rem 0}.campaign-stats{display:flex;gap:1rem}.campaign ol{display:grid;grid-template-columns:repeat(13,minmax(108px,1fr));gap:.4rem;overflow-x:auto;margin:1rem 0 0;padding:0 0 .5rem;list-style:none}.campaign li{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:.4rem;min-width:108px;padding:.58rem;border:1px solid var(--border);border-radius:.55rem}.campaign li>span{display:grid;place-items:center;width:24px;aspect-ratio:1;border-radius:50%;background:var(--surface);font:0.72rem var(--mono)}.campaign li.current{border-color:var(--accent);background:color-mix(in srgb,var(--accent) 7%,var(--panel))}.campaign li.won>span{background:var(--accent);color:var(--accent-ink)}.campaign li.failed{border-color:color-mix(in srgb,var(--danger) 40%,var(--border))}.pool-note,.async-note{display:flex;align-items:center;gap:.45rem;padding:.65rem;border-radius:.55rem;background:color-mix(in srgb,var(--warning) 8%,transparent);font-size:.72rem}.offer-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:.7rem;margin-top:1rem}.offer-grid button{position:relative;display:grid;gap:.35rem;min-height:205px;padding:1.1rem;border:1px solid var(--border);border-radius:.75rem;background:var(--panel-strong);color:var(--text);text-align:left;cursor:pointer;transition:transform .16s ease,border-color .16s ease}.offer-grid button:hover:not(:disabled),.offer-grid button:focus-visible{transform:translateY(-3px);border-color:var(--accent)}.offer-grid button>span,.offer-grid button p{color:var(--muted);font:0.72rem var(--mono)}.offer-grid h3{margin:.5rem 0 0;font-size:1.25rem}.offer-grid em{position:absolute;inset:0;display:grid;place-items:center;border-radius:inherit;background:color-mix(in srgb,var(--bg) 88%,transparent);color:var(--accent);font-style:normal}.draft footer,.training footer,.team-review footer{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-top:1rem}.agent-actions,.team-tools{display:flex;flex-wrap:wrap;gap:.5rem}.offer-saved{color:var(--muted);font:0.72rem var(--mono)}.offer-saved i{color:var(--accent)}.training-actions{display:flex;align-items:center;gap:.8rem}.ev-counter{display:grid;text-align:right}.ev-counter strong{color:var(--accent);font-size:1.7rem}.ev-counter span{color:var(--muted);font:0.72rem var(--mono)}.ev-cards{display:grid;gap:.55rem;margin-top:1rem}.ev-cards article{display:grid;gap:.65rem;padding:.8rem;border:1px solid var(--border);border-radius:.65rem;background:var(--panel-strong)}.ev-mon{display:flex;align-items:center;justify-content:space-between}.ev-mon>div{display:grid}.ev-mon small{color:var(--muted);font:0.72rem var(--mono)}.ability-field{display:grid;gap:.25rem;padding:.6rem;border:1px solid color-mix(in srgb,var(--accent) 30%,var(--border));border-radius:.55rem;background:color-mix(in srgb,var(--accent) 5%,transparent)}.ability-field>span{font-weight:700}.ability-field select{width:100%}.ability-field small,.ability-unavailable{color:var(--muted);font:0.72rem/1.4 var(--mono)}.ability-unavailable{display:flex;align-items:center;gap:.4rem;margin:0}.preset-row{display:flex;flex-wrap:wrap;gap:.35rem}.preset-row button,.stat-grid label button{min-height:30px;padding:.3rem .45rem;border:1px solid var(--border);border-radius:.45rem;background:var(--surface);color:var(--muted);font:0.72rem var(--mono);cursor:pointer}.preset-row button:hover,.stat-grid label button:hover{border-color:var(--accent);color:var(--accent)}.stat-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:.4rem}.stat-grid label{display:grid;grid-template-columns:1fr auto;gap:.25rem}.stat-grid label span{grid-column:1/-1;color:var(--muted);font:0.72rem var(--mono)}.stat-grid input{min-width:0;min-height:34px;padding:.35rem;text-align:center}.training-notice{padding:.55rem;border-radius:.5rem;background:color-mix(in srgb,var(--accent) 7%,transparent);font-size:0.72rem}.team-review{display:grid;grid-template-columns:.8fr 1.2fr;gap:1.25rem}.team-review>label{display:grid;gap:.35rem}.team-review textarea{width:100%;font:0.72rem/1.5 var(--mono)}.team-review footer{grid-column:1/-1}.team-review footer span{color:var(--muted);font-size:0.72rem}.lock-note{display:flex;align-items:center;gap:.55rem;margin-top:1rem;padding:.7rem;border:1px solid var(--border);border-radius:.55rem}.lock-note i{color:var(--warning);font-size:1.2rem}.lock-note span{display:grid}.lock-note small{color:var(--muted);font:0.72rem var(--mono)}.stage,.active{display:flex;align-items:center;justify-content:space-between;gap:2rem}.level-rule{display:flex;align-items:center;gap:.8rem;margin-top:1rem;padding:.75rem;border:1px solid var(--border);border-radius:.6rem}.retry-note{padding:.55rem;border-radius:.5rem;background:color-mix(in srgb,var(--warning) 8%,transparent);font-size:0.72rem}.launch{min-height:54px}.live-dot{width:12px;aspect-ratio:1;border-radius:50%;background:var(--accent);box-shadow:0 0 0 6px color-mix(in srgb,var(--accent) 14%,transparent);animation:pulse 1.8s infinite}@keyframes pulse{50%{opacity:.45}}.complete,.ending{display:grid;place-items:center;padding:2.5rem;text-align:center}.complete>.ph,.ending>.ph{color:var(--accent);font-size:3rem}.complete dl{display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem;width:100%;margin:1rem 0}.complete dl div{display:grid;padding:.65rem;border:1px solid var(--border);border-radius:.55rem}.complete dt{color:var(--muted);font:0.72rem var(--mono)}.complete dd{margin:.2rem 0 0;font-weight:700}.final-roster{display:flex;flex-wrap:wrap;justify-content:center;gap:.4rem}.final-roster span{display:grid;padding:.4rem .6rem;border:1px solid var(--border);border-radius:.55rem}.final-roster small{color:var(--muted);font:0.72rem var(--mono)}.final-actions,.ending>div{display:flex;gap:.5rem;margin-top:1rem}.run-details{margin-bottom:1rem;padding:1rem;box-shadow:none}.run-details dl{display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem}.run-details dt{color:var(--muted);font:0.72rem var(--mono)}.run-details dd{overflow-wrap:anywhere;margin:.2rem 0}.error-box{position:sticky;bottom:1rem;z-index:5;display:grid;grid-template-columns:1fr auto;gap:.5rem;margin-top:1rem;padding:.8rem;border:1px solid var(--danger);border-radius:.65rem;background:var(--panel);color:var(--danger);box-shadow:var(--shadow)}.error-box details{grid-column:1/-1;color:var(--muted)}.load-error{display:grid;justify-items:start;gap:.7rem;padding:1.5rem}@media(max-width:900px){.page-head,.campaign header,.draft header,.training header,.stage,.active,.result-card{align-items:stretch;flex-direction:column}.campaign-stats{flex-wrap:wrap}.offer-grid{grid-template-columns:repeat(2,1fr)}.team-review{grid-template-columns:1fr}.team-review footer{grid-column:auto}.ev-counter{text-align:left}.result-actions{align-self:stretch}.result-actions>*{flex:1}.stat-grid{grid-template-columns:repeat(3,1fr)}}@media(max-width:600px){.continue-card,.snapshot-warning{align-items:stretch;flex-direction:column}.continue-card .button{width:100%}.head-actions{align-items:flex-start;flex-direction:column}.offer-grid,.complete dl,.run-details dl{grid-template-columns:1fr}.draft footer,.training footer,.team-review footer{align-items:stretch;flex-direction:column}.stat-grid{grid-template-columns:repeat(2,1fr)}.final-actions,.ending>div,.result-actions{display:grid;width:100%}.error-box{grid-template-columns:1fr}}.offer-grid button{grid-template-columns:1fr auto;min-height:360px;overflow:hidden;background:radial-gradient(circle at 50% 35%,color-mix(in srgb,var(--accent) 9%,transparent),transparent 40%),var(--panel-strong)}.offer-grid button::after{content:"";position:absolute;inset:0;pointer-events:none;border-radius:inherit;box-shadow:inset 0 1px rgba(255,255,255,.06)}.offer-grid .shortcut{position:absolute;top:.75rem;right:.75rem;display:grid;place-items:center;width:28px;aspect-ratio:1;border:1px solid var(--border);border-radius:.45rem;background:var(--surface);color:var(--text);font:700 0.72rem var(--mono)}.offer-grid .dex{grid-column:1/-1}.offer-sprite{grid-column:1/-1;display:grid;place-items:center;min-height:138px}.offer-grid h3{grid-column:1/-1;margin:0;font-size:1.4rem}.offer-grid :global(.type-list){grid-column:1/-1}.offer-grid em{z-index:3;grid-template-columns:auto auto;gap:.35rem}.offer-grid em i{animation:spin .8s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.ev-cards{grid-template-columns:repeat(2,minmax(0,1fr));gap:.75rem}.ev-cards article{padding:1rem;background:linear-gradient(145deg,color-mix(in srgb,var(--accent) 4%,var(--panel-strong)),var(--panel-strong))}.ev-identity{display:flex;align-items:center;gap:.8rem}.ev-mon{flex:1}.ev-mon>div{gap:.32rem}.ev-progress{height:5px;overflow:hidden;border-radius:999px;background:var(--surface)}.ev-progress span{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,var(--accent),color-mix(in srgb,var(--accent) 55%,var(--accent-gradient-partner)));transition:width .2s ease}.preset-row{display:grid;grid-template-columns:repeat(3,1fr);gap:.4rem}.preset-row button{display:grid;align-content:start;gap:.22rem;min-height:72px;padding:.55rem;text-align:left}.preset-row button span{display:grid;gap:.15rem;color:var(--text);font-weight:700}.preset-row button small{line-height:1.3}.preset-row button b{width:max-content;padding:.12rem .3rem;border-radius:999px;background:color-mix(in srgb,var(--accent) 18%,transparent);color:var(--accent);font:0.72rem var(--mono);text-transform:uppercase}.preset-row button.recommended{border-color:color-mix(in srgb,var(--accent) 58%,var(--border));background:color-mix(in srgb,var(--accent) 8%,var(--surface))}.stat-grid label{padding:.45rem;border:1px solid color-mix(in srgb,var(--border) 75%,transparent);border-radius:.5rem;background:color-mix(in srgb,var(--surface) 72%,transparent)}.stat-grid label span{display:flex;justify-content:space-between}.stat-grid label span b{color:var(--text);font-weight:700}.roll-result{align-items:center!important;padding:.7rem clamp(.9rem,2vw,1.35rem);border:1px solid color-mix(in srgb,var(--accent) 48%,var(--border));border-radius:.8rem;background:radial-gradient(circle at 20% 50%,color-mix(in srgb,var(--accent) 16%,transparent),transparent 48%),var(--panel-strong)}.roll-result h2{display:flex;align-items:center;gap:.65rem;margin:.35rem 0;font-size:clamp(1.55rem,3vw,2.45rem)}.roll-result h2 span{padding:.22rem .55rem;border-radius:.45rem;background:color-mix(in srgb,var(--accent) 13%,transparent)}.draft-workspace{display:grid;grid-template-columns:minmax(0,1fr) 220px;gap:1rem;margin-top:1rem}.draft-choice-area{min-width:0}.draft-roster{position:sticky;top:1rem;align-self:start;padding:.9rem;border:1px solid var(--border);border-radius:.75rem;background:var(--panel-strong)}.draft-roster h3{margin:.2rem 0 .65rem;color:var(--accent);font-size:1.4rem}.draft-roster>div{display:grid;gap:.4rem}.draft-roster article{display:grid;grid-template-columns:42px 1fr;align-items:center;gap:.45rem;min-height:52px;padding:.35rem;border:1px solid var(--border);border-radius:.55rem;background:var(--panel)}.draft-roster article>span{display:grid;min-width:0}.draft-roster article strong{overflow:hidden;font-size:0.72rem;text-overflow:ellipsis;white-space:nowrap}.draft-roster article.empty{color:var(--muted)}.draft-roster article.empty b{display:grid;place-items:center;width:34px;aspect-ratio:1;border:1px dashed var(--border);border-radius:50%;font:0.72rem var(--mono)}.draft-roster article.empty span{font:0.72rem var(--mono)}.draft-roster details{margin-top:.7rem;color:var(--muted);font-size:0.72rem}.draft-roster details p{margin:.5rem 0 0;font-size:0.72rem}
  ...
  .page-head{position:relative;z-index:90;display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:.35rem}.run-id{min-width:0}.run-id h1{margin:.1rem 0 0;overflow:hidden;font-size:clamp(1.05rem,1.8vw,1.45rem);text-overflow:ellipsis;white-space:nowrap}.head-actions{display:flex;flex-shrink:0;align-items:center;gap:.45rem}.difficulty-pill{padding:.24rem .55rem;border:1px solid color-mix(in srgb,var(--accent) 40%,var(--border));border-radius:999px;color:var(--accent);font:700 0.72rem var(--mono);letter-spacing:.05em;text-transform:uppercase;white-space:nowrap}.run-menu{position:relative;z-index:50}.run-menu>summary{display:flex;min-height:44px;align-items:center;gap:.35rem;padding:.3rem .65rem;border:1px solid var(--border);border-radius:999px;background:var(--panel);color:var(--muted);font:650 .72rem var(--display);cursor:pointer;list-style:none}.run-menu>summary::-webkit-details-marker{display:none}.run-menu[open]>summary,.run-menu>summary:hover{border-color:color-mix(in srgb,var(--accent) 45%,var(--border));color:var(--text)}.run-menu-panel{position:absolute;z-index:60;top:calc(100% + .4rem);right:0;display:grid;gap:.18rem;width:min(21rem,80vw);padding:.5rem;border:1px solid var(--border);border-radius:var(--radius-lg);background:var(--panel);box-shadow:var(--shadow)}.run-menu-label{margin:.25rem .35rem 0;color:var(--accent);font:700 0.72rem var(--mono);letter-spacing:.13em;text-transform:uppercase}.run-menu-note{margin:0 .35rem .3rem!important;font-size:0.72rem;line-height:1.45}.run-menu-item{display:flex;min-height:44px;align-items:center;gap:.5rem;width:100%;padding:.45rem .55rem;border:0;border-radius:.5rem;background:transparent;color:var(--text);font:600 .8rem var(--display);text-align:left;cursor:pointer}.run-menu-item:hover{background:var(--surface)}.run-menu-item.danger{color:var(--danger)}.stage-hero{display:flex;align-items:center;gap:1.1rem;margin-bottom:.7rem;padding:1rem 1.2rem;border-color:color-mix(in srgb,var(--stage-accent) 55%,var(--border));background:linear-gradient(105deg,color-mix(in srgb,var(--stage-accent) 16%,var(--panel)),var(--panel))}.stage-copy{min-width:0;flex:1}.stage-copy .eyebrow{color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix))}.stage-copy h2{margin:.1rem 0;font-size:clamp(1.5rem,3.4vw,2.1rem);line-height:1.05}.stage-copy p{margin:.15rem 0 0!important;font-size:.76rem}.stage-copy p b{color:var(--text)}.retry-note{color:var(--danger)!important}.stage-action{display:grid;flex-shrink:0;justify-items:end;gap:.4rem;text-align:right}.stage-action>strong{font:700 0.72rem var(--mono)}.stage-buttons{display:flex;flex-wrap:wrap;align-items:center;justify-content:flex-end;gap:.45rem}.stage-action .link-button{font-size:0.72rem}.campaign{margin-bottom:.7rem;padding:.85rem 1.1rem;box-shadow:none}.campaign header{display:flex;align-items:center;justify-content:space-between;gap:1rem}.campaign h2{margin:.1rem 0;font-size:.98rem}.route-count{color:var(--muted);font:0.72rem var(--mono)}.route-rail{display:flex;flex-wrap:wrap;gap:.3rem;margin:.6rem 0 0;padding:0;list-style:none}.route-rail li{display:flex;align-items:center;gap:.32rem;padding:.24rem .5rem;border:1px solid var(--border);border-radius:999px;background:var(--surface);color:var(--muted);font:650 0.72rem var(--display)}.route-rail li b{display:grid;place-items:center;width:19px;aspect-ratio:1;border-radius:50%;background:var(--surface);color:var(--muted);font:800 0.72rem var(--mono);box-shadow:inset 0 0 0 1px var(--border)}.route-rail li.won{border-color:color-mix(in srgb,var(--accent) 45%,var(--border));color:var(--text)}.route-rail li.won b{background:var(--accent);color:var(--bg);box-shadow:none}.route-rail li.failed b{background:var(--danger);color:#fff;box-shadow:none}.route-rail li.current{border-color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix));background:color-mix(in srgb,var(--stage-accent) 20%,var(--panel));color:var(--text)}.route-rail li.current b{background:var(--stage-accent);color:#0b100c;box-shadow:none}.route-rail li:not(.current):not(.won):not(.failed) span{display:none}.roster-strip{display:flex;flex-wrap:wrap;gap:.35rem;margin-bottom:.7rem}.roster-strip span{display:flex;align-items:center;gap:.35rem;padding:.22rem .5rem .22rem .25rem;border:1px solid var(--border);border-radius:999px;background:var(--panel);color:var(--muted);font:650 0.72rem var(--display)}.evolved-mark{color:var(--accent);font-size:.8em}.final-roster .evolved-mark{margin-left:.2rem}/* ── Slot reels ─────────────────────────────────────────────────────────── */
  ...
  @keyframes reel-lock{0%,74%{border-color:var(--accent);box-shadow:0 0 0 2px color-mix(in srgb,var(--accent) 8%,transparent)}88%{border-color:color-mix(in srgb,var(--accent) 90%,white);box-shadow:0 0 22px 2px color-mix(in srgb,var(--accent) 55%,transparent),0 0 0 3px color-mix(in srgb,var(--accent) 22%,transparent);transform:scale(1.06)}100%{border-color:var(--accent);box-shadow:0 0 0 2px color-mix(in srgb,var(--accent) 10%,transparent);transform:scale(1)}}.reroll-control{position:relative;display:block;min-width:0}.reroll-control .button{width:100%;height:100%}.reroll-control.unavailable{border-radius:.7rem;cursor:help}.reroll-control[data-tooltip]::after{position:absolute;z-index:120;right:0;bottom:calc(100% + .55rem);width:max-content;max-width:min(320px,80vw);padding:.55rem .65rem;border:1px solid color-mix(in srgb,var(--accent) 38%,var(--border));border-radius:.55rem;background:var(--panel-strong);box-shadow:var(--shadow-sm);color:var(--text);font:600 0.72rem/1.4 var(--display);text-align:left;white-space:normal;content:attr(data-tooltip);opacity:0;pointer-events:none;transform:translateY(4px);transition:opacity .14s ease,transform .14s ease}.reroll-control[data-tooltip]:hover::after,.reroll-control[data-tooltip]:focus-visible::after,.reroll-control[data-tooltip]:focus-within::after{opacity:1;transform:none}.reroll-control:focus-visible{outline:2px solid var(--accent);outline-offset:3px}.reroll-blocked{display:grid;gap:.2rem;margin:.5rem 0 0;padding:0;list-style:none}.reroll-blocked li{display:flex;flex-wrap:wrap;gap:.35rem;color:var(--muted);font-size:0.72rem}.reroll-blocked b{color:var(--text)}.agent-busy{display:flex;align-items:center;gap:.4rem;color:var(--accent);font:700 .74rem var(--display)}.agent-busy i{animation:agent-pulse 1.6s ease-in-out infinite}
  ...
  .campaign-preview{display:grid;gap:.15rem;margin:.5rem 0 .6rem;padding:0;list-style:none}.campaign-preview li{display:grid;grid-template-columns:auto 1fr auto;align-items:baseline;gap:.4rem;padding:.16rem .4rem;border-left:3px solid var(--stage-accent);border-radius:.3rem;background:var(--surface)}.campaign-preview b{color:var(--text);font:700 0.72rem var(--display)}.campaign-preview span{overflow:hidden;color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix));font:650 0.72rem var(--mono);text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap}.campaign-preview i{color:var(--muted);font:600 0.72rem var(--mono);font-style:normal}.run-error{display:flex;align-items:flex-start;gap:.75rem;margin-bottom:.7rem;padding:.8rem 1rem;border-color:color-mix(in srgb,var(--danger) 45%,var(--border));background:color-mix(in srgb,var(--danger) 7%,var(--panel))}.run-error>i{color:var(--danger);font-size:1.15rem}.run-error>div{min-width:0;flex:1}.run-error strong{display:block;font-size:.88rem}.run-error p{margin:.2rem 0!important;overflow-wrap:anywhere;font-size:.72rem}.run-error small{color:var(--muted);font:0.72rem var(--mono)}
  ...
  .disclosure-summary small{overflow:hidden;color:var(--muted);font:0.72rem var(--mono);text-overflow:ellipsis;white-space:nowrap}
  ...
  .reroll-policy{display:flex;align-items:flex-start;gap:.35rem;grid-column:1/-1;margin:.35rem 0 0;color:var(--muted);font:0.72rem/1.35 var(--display)}
  ...
  .stage-transition-card span{color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix));font:700 0.72rem var(--mono);letter-spacing:.08em;text-transform:uppercase}
  ...
  .rarity-badge{justify-self:start;padding:.22rem .45rem;border:1px solid var(--rarity-border,var(--border));border-radius:999px;background:color-mix(in srgb,var(--rarity-accent,var(--accent)) 9%,var(--surface));color:var(--rarity-accent,var(--text));font:750 0.72rem var(--mono);letter-spacing:.03em;text-transform:uppercase}
  ...
  .mega-options button>span{display:grid;gap:.1rem;min-width:0}.mega-options small,.mega-options em{overflow:hidden;color:var(--muted);font:0.72rem var(--mono);font-style:normal;text-overflow:ellipsis;white-space:nowrap}.mega-options strong{font-size:.78rem}.mega-options i{color:#b987ff}
  ...
  .battle-overview>header small{color:var(--muted);font:0.72rem var(--mono);text-align:right}
  ...
  .battle-overview-stage small{color:var(--muted);font:0.72rem var(--mono)}
  ...
  .battle-overview-teams b{color:var(--muted);font:0.72rem var(--mono);letter-spacing:.06em;text-transform:uppercase}
  .battle-overview-teams span{display:flex;align-items:center;flex-wrap:wrap;gap:.25rem .45rem;color:var(--text);font-size:0.72rem}
  ...
  .battle-overview-list dt{color:var(--muted);font:0.72rem var(--mono);text-transform:uppercase}
  .battle-overview-list dd{margin:0;font-weight:700;font-size:.72rem}
  .battle-overview-faints{margin:0;color:var(--muted);font-size:0.72rem;line-height:1.35}
  ...
  .evolution-rarity-badge{justify-self:start;padding:.2rem .4rem;border:1px solid color-mix(in srgb,var(--warning) 55%,var(--border));border-radius:999px;background:color-mix(in srgb,var(--warning) 9%,var(--surface));color:var(--warning)!important;font:700 0.72rem var(--mono)!important;text-transform:uppercase}
  ...
  .route-rail li>span.attempt-state{position:absolute;z-index:2;top:.2rem;left:.2rem;display:grid;place-items:center;width:14px;height:14px;border:1px solid var(--border);border-radius:50%;background:var(--surface);color:var(--muted);font:800 0.72rem var(--mono)}
  ...
  .route-entry strong{font:750 0.72rem var(--display)}
  .route-entry small{color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix));font:650 0.72rem var(--mono);text-transform:uppercase}
  .stage-emblem{display:grid;place-items:center;width:25px;aspect-ratio:1;border:1px solid color-mix(in srgb,var(--stage-accent) 58%,var(--border));border-radius:50%;background:color-mix(in srgb,var(--stage-accent) 16%,var(--panel));color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix));font:800 0.72rem var(--mono);font-style:normal}
  ...
  .route-rail li.current{border-color:color-mix(in srgb,var(--stage-accent),var(--text) var(--accent-ink-mix));background:color-mix(in srgb,var(--stage-accent) 12%,var(--panel));box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--stage-accent) 30%,transparent)}
  ...
  .team-performance,.same-team{margin-top:.75rem;padding:1rem 1.1rem}.team-performance>header,.same-team{display:grid;gap:.65rem}.team-performance>header{grid-template-columns:minmax(0,1fr) auto;align-items:end}.team-performance h2,.same-team h2{margin:.2rem 0 0;font-size:1.2rem}.team-performance>header>small{color:var(--muted);font:0.72rem var(--mono)}.pokemon-stat-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.6rem;margin-top:.8rem}.pokemon-stat-card{display:grid;gap:.55rem;padding:.75rem;border:1px solid var(--border);border-radius:.7rem;background:var(--panel-strong)}.pokemon-stat-card>header{display:flex;align-items:center;gap:.55rem;min-width:0}.pokemon-stat-card>header>div{display:grid;gap:.15rem;min-width:0}.pokemon-stat-card strong{font-size:.86rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pokemon-stat-card header small{color:var(--muted);font:0.72rem var(--mono)}.pokemon-stat-card dl{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.3rem}.pokemon-stat-card dl div{display:flex;align-items:baseline;justify-content:space-between;gap:.4rem;padding:.26rem .35rem;border-radius:.35rem;background:var(--surface)}.pokemon-stat-card dt{color:var(--muted);font:0.72rem var(--mono)}.pokemon-stat-card dd{margin:0;color:var(--text);font:800 .72rem var(--display)}.base-stat-line{color:var(--muted);font:0.72rem/1.35 var(--mono)}.empty-stats{margin:.8rem 0 0!important;color:var(--muted);font-size:.72rem}.same-team{grid-template-columns:minmax(0,1fr) minmax(18rem,.9fr);align-items:end;border-color:color-mix(in srgb,var(--accent) 42%,var(--border));background:color-mix(in srgb,var(--accent) 5%,var(--panel))}.same-team p{margin:.3rem 0 0!important;color:var(--muted);font-size:.72rem;line-height:1.45}.same-team-controls{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:.55rem}.same-team-controls label{display:grid;gap:.25rem;color:var(--muted);font:0.72rem var(--mono)}.same-team-controls select{min-height:42px;padding:.45rem .55rem;border:1px solid var(--border);border-radius:.5rem;background:var(--panel-strong);color:var(--text);font:650 0.72rem var(--display)}.same-team .error{grid-column:1/-1;margin:0!important}
