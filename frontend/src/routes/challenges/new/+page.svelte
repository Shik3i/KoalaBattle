<script lang="ts">
  ...
  // Difficulty only lowers the player's stage level; opponent teams and levels never change.
  const DIFFICULTIES: Array<{ id: Difficulty; label: string; detail: string; icon: string }> = [
    { id: 'normal', label: 'Normal', detail: 'Equal levels', icon: 'ph-shield-check' },
    { id: 'hard', label: 'Hard', detail: 'You −5 levels', icon: 'ph-barbell' },
    { id: 'expert', label: 'Expert', detail: 'You −10 levels', icon: 'ph-scales' },
    { id: 'nightmare', label: 'Nightmare', detail: 'You −15 levels', icon: 'ph-flame' }
  ];
