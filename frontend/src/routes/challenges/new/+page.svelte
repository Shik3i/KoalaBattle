...
<style>
  ...
  .fixed-opponent{display:grid;align-content:center;gap:.2rem;color:var(--muted);font-size:.72rem}.fixed-opponent strong{color:var(--text)}.fixed-opponent strong i{color:var(--accent)}.fixed-opponent small,.advanced-grid label>small{font-size:.62rem;line-height:1.35;color:var(--muted)}.advanced-grid label>small{display:block;margin-top:-.25rem}
